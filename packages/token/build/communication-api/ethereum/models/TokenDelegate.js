...
class TokenDelegate {
  ...
  init(contractMeta, contractAddress, fromAddress, toAddress) {
    console.log("Initializing TokenDelegate contract", arguments); //web3.setProvider(new web3.providers.HttpProvider("https://ropsten.infura.io/XXXXXX"))
...
var _default = new TokenDelegate();
